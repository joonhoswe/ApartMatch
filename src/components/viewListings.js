...
export default function ViewListings({ loading, listings, onListingClick }) {
    ...
    return (
        <div className='h-[calc(100vh-54px)] w-full sm:w-2/5 sm:flex flex-col justify-center items-center space-y-6 text-black border-2 bg-white border-gray-500 py-10 '>
            {!isAuthenticated ? (
            ...
            <div className='h-full overflow-auto w-full sm:flex sm:flex-wrap gap-8 grid grid-cols-1 justify-items-center justify-center'>
                {loading ? (
