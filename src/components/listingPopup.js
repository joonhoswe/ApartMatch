    ...
    return (
        <div className='z-50 relative h-full w-full bg-white text-black rounded-lg flex flex-col items-center justify-between' >
            ...
            <div className='h-3/5 w-full mb-2 relative'>
                ...
                <button onClick={handleNext} className='z-10 absolute top-1/2 right-4 h-9 w-9 md:h-12 md:w-12 rounded-full bg-white text-black flex items-center justify-center text-base md:text-2xl font-bold shadow-2xl hover:bg-red-500 transition ease-in-out duration-300'> 〉  </button>
