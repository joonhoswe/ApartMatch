...
export default function postListing() {
    ...
    return(
        <div className="bg-gray-200 flex flex-col justify-center items-center w-full h-screen" >
            <div className="bg-white text-xs sm:text-base rounded-2xl p-8 shadow-2xl text-black text-center w-full sm:w-3/5 md:w-3/5 lg:w-1/3 flex flex-col space-y-3">
                <div className = "text-base sm:text-xl p-4 rounded-2xl font-bold border-y-8 border-red-500 mb-6">
