...
export default function Home() {
  ...
  const infoCards = [
    { 
      heading: '❌ Online housing forums? Yuck.', 
    ...
    { 
      heading: '✅ See openings in real time', 
    ...
    { 
      heading: '🔒 Only .edu emails allowed', 
    ...
    <div className="flex flex-col items-center w-full h-[calc(100vh-54px)] text-white font-bold">
      ...
      <div className='bg-gray-200 w-full flex flex-col md:flex-row space-y-12 md:space-y-0 md:space-x-6 lg:space-x-12 items-center justify-center px-4 py-10'>
        {infoCards.map((card, index) => (
          <div key={index} className='bg-white text-black h-56 md:h-72 w-64 md:w-80 rounded-2xl flex flex-col items-center space-y-4 p-4 md:p-6 shadow-2xl'>
